...
public class JavaTestProcessor extends AbstractProcessor {
    ...
    public static String GENERATED_PACKAGE = "com.atom.compile.core";
    ...
    private void writeKotlinFile(FileSpec fileSpec, String fileName, String packageName) {
        ...
        processingEnv.getMessager().printMessage(Diagnostic.Kind.WARNING, "writeKotlinFile "+outputFolder.getAbsolutePath());
